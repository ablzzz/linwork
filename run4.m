...
%save('Result_svm_cafe_nall_combinespec.mat', 'Result_svm_cafe_nall_combinespec*')
...
save('Result_svm_car_nall_combinespec.mat', 'Result_svm_carwinup_nall_combinespec*')
